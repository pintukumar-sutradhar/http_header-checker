"""
header_checker/core/scan_engine.py
=========================
...
This module contains no web-framework or GUI imports -- it is pure logic
and is reused by the CLI, the web dashboard, and the test suite.
"""
...
from header_checker.utils.logger import get_logger
...
from .cookie_scanner import cookie_findings, parse_all_cookies
from .csp_analyzer import csp_findings, parse_csp
...
ProgressCallback = Callable[[ScanStage, str], None] | None
...
def run_scan(
    ...
    try:
        ...
        # Only analyze CSP quality when a policy exists; the missing-CSP case
        # is already reported by evaluate_headers (no duplicate findings).
