...
_add(HeaderDefinition(
    ...
    # NOTE: 'max-age=0' is intentionally NOT listed in weak_values -- the
    # dedicated deep check in header_scanner classifies it as MISCONFIGURED/HIGH.
))
...
def get_definition(header_name: str) -> HeaderDefinition | None:
