"""
header_checker/core/tls_scanner.py
========================
...
from header_checker.utils.constants import WEAK_CIPHER_KEYWORDS, WEAK_TLS_VERSIONS
from header_checker.utils.logger import get_logger
from header_checker.utils.models import Finding, Severity, TLSAnalysis
